...
| 6 | Nuestra copia (transcripción) de los campos tiene errores: ¿cómo los corregimos comparándola con los documentos oficiales DT1 y DT2? (~~celdas duplicadas en `numNota`~~ → **resuelto**: `numNota` (T04) lo genera el facturador y = nº reportado a DIAN, DT1 v002; residual: "Campos FEV-salud" y "Soportes de cobro") | modelo-datos | parcial | [[Notas crédito y débito (NC · ND) — flujo, campos y reglas]] |
