...
- **Recaudo:** el **concepto** (copago/cuota moderadora/no aplica) se fija **por contrato**; el **valor** se resuelve por el **nivel de contribución** del paciente en la orden. Copago limitado a **≤100 %**.
